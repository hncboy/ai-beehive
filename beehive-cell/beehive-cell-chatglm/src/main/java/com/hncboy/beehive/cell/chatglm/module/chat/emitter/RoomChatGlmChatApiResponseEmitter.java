...
import com.hncboy.beehive.cell.chatglm.module.chat.api.ChatGlmCompletionBuildUtil;
...
@Lazy
@Component
public class RoomChatGlmChatApiResponseEmitter implements RoomChatGlmResponseEmitter {
    ...
    public void requestToResponseEmitter(RoomChatGlmSendRequest sendRequest, ResponseBodyEmitter emitter, CellConfigStrategy cellConfigStrategy) {
        ...
        OpenAiStreamClient openAiStreamClient = OpenAiStreamClient.builder()
                ...
                //使用openai客户端，apikey随意设置一个即可
                .apiKey(Arrays.asList("xxx"))
